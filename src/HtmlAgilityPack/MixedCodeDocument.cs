...
namespace HtmlAgilityPack
{
    ...
    public class MixedCodeDocument
    {
        ...
        public void Load(string path)
        {
            ...
            {
                Load(new StreamReader(fileStream));
            }
        }
        ...
        public void Load(string path, bool detectEncodingFromByteOrderMarks)
        {
            using (var fileStream = File.OpenRead(path))
            {
                Load(new StreamReader(fileStream, detectEncodingFromByteOrderMarks));
            }
        }
        ...
        public void Load(string path, Encoding encoding)
        {
            using (var fileStream = File.OpenRead(path))
            {
                Load(new StreamReader(fileStream, encoding));
            }
        }
        ...
        public void Load(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        {
            using (var fileStream = File.OpenRead(path))
            {
                Load(new StreamReader(fileStream, encoding, detectEncodingFromByteOrderMarks));
            }
        }
        ...
        public void Load(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks, int buffersize)
        {
            using (var fileStream = File.OpenRead(path))
            {
                Load(new StreamReader(fileStream, encoding, detectEncodingFromByteOrderMarks, buffersize));
            }
        }
