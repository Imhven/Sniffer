...
namespace HtmlAgilityPack
{
    ...
    public class HtmlDocument : IXPathNavigable
    {
        ...
        public Encoding DetectEncoding(string path)
        {
            ...
            {
                StreamReader sr = new StreamReader(fileStream, OptionDefaultStreamEncoding);
        ...
        public void Load(string path, bool detectEncodingFromByteOrderMarks)
        {
            ...
            using (var fileStream = File.OpenRead(path))
            {
                StreamReader sr = new StreamReader(fileStream, detectEncodingFromByteOrderMarks);
                Load(sr);
                sr.Dispose();
            }
        }
        ...
        public void Load(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks)
        {
            ...
            using (var fileStream = File.OpenRead(path))
            {
                StreamReader sr = new StreamReader(fileStream, encoding, detectEncodingFromByteOrderMarks);
                Load(sr);
                sr.Dispose();
            }
        }
        ...
        public void Load(string path, Encoding encoding, bool detectEncodingFromByteOrderMarks, int buffersize)
        {
            ...
            using (var fileStream = File.OpenRead(path))
            {
                StreamReader sr = new StreamReader(fileStream, encoding, detectEncodingFromByteOrderMarks, buffersize);
                Load(sr);
                sr.Dispose();
            }
        }
        ...
        public void Save(string filename)
        {
            ...
            {
                StreamWriter sw = new StreamWriter(fileStream, GetOutEncoding());
                Save(sw);
                sw.Dispose();
            }
        }
